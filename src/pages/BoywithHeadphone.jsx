...
const BoywithHeadphone = () => {
  const { x, y } = useMousePosition();
  const [cursorHoverd, setCursorHoverd] = useState(false);
  const { open, isOpen } = useglobalHook();
  return (
    <div className=" relative h-[100vh] w-[100vw] flex items-center justify-center text-5xl overflow-hidden">
      <motion.div
        animate={{
          x: x,
          y: y,
      ...
      <img src="/BoyWithMusic.jpg" className="w-[300px] h-[300px]" />
    </div>
  );
};

export default BoywithHeadphone;
